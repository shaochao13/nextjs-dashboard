  ...
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      ...
      <div className=" rounded-xl bg-gray-100 p-4">
        <div className=" mt-0 grid h-[410px] grid-cols-12 items-end gap-2 rounded-md bg-white p-4 sm:grid-cols-13 md:gap-4"></div>
    ...
    <div className="flex flex-row items-center justify-between border-b border-gray-100 py-4">
      <div className=" flex items-center">
        ...
        <div className=" min-w-0">
          ...
          <div className=" mt-2 h-4 w-12 rounded-md bg-gray-200"></div>
        </div>
      </div>
      <div className=" mt-2 h-4 w-12 rounded-md bg-gray-200"></div>
    </div>
  ...
  return (
    <div className=" mb-2 w-full rounded-md bg-white p-4">
      <div className="flex items-center justify-between border-b border-gray-100 pb-8">
        <div className="flex items-center">
          <div className="mr-2 h-8 rounded-full bg-gray-100"></div>
